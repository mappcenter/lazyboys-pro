...
public class StatsMonitor {
	...
	public String dumpHtmlStats() {
		...
		content = "<ul>"
				...
				+ "<li>recent req/s : " + this.getTotalOpsPerSec() + "</li>"
				+ "<li>peak req/s : " + this.getRPSPeak() + " - " + dateformat.format(new Date(this.getRPSPeakTime())) + "</li>"
				+ "<li>mean latency: " + formatter.format(this.latencyTracker.getAvgLatency() / 1000) + " msecs </li>"
				+ "<li>recent avg latency : " + formatter.format(this.latencyTracker.getRecentLatencyMicros() / 1000) + " msecs </li>"
