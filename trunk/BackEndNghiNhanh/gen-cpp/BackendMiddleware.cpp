...
uint32_t BackendMiddleware_getItemsPageKeyword_args::read(::apache::thrift::protocol::TProtocol* iprot) {
...
uint32_t BackendMiddleware_getItemsPageKeyword_args::write(::apache::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  xfer += oprot->writeStructBegin("BackendMiddleware_getItemsPageKeyword_args");

  xfer += oprot->writeFieldBegin("keyWord", ::apache::thrift::protocol::T_STRING, 1);
  xfer += oprot->writeString(this->keyWord);
  xfer += oprot->writeFieldEnd();

  xfer += oprot->writeFieldBegin("pageNumber", ::apache::thrift::protocol::T_I64, 2);
  xfer += oprot->writeI64(this->pageNumber);
  xfer += oprot->writeFieldEnd();

  xfer += oprot->writeFieldBegin("itemNumber", ::apache::thrift::protocol::T_I64, 3);
  xfer += oprot->writeI64(this->itemNumber);
  xfer += oprot->writeFieldEnd();
...
uint32_t BackendMiddleware_getItemsPageKeyword_pargs::write(::apache::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  xfer += oprot->writeStructBegin("BackendMiddleware_getItemsPageKeyword_pargs");
...
uint32_t BackendMiddleware_getItemsPageKeyword_result::read(::apache::thrift::protocol::TProtocol* iprot) {
...
uint32_t BackendMiddleware_getItemsPageKeyword_result::write(::apache::thrift::protocol::TProtocol* oprot) const {

  uint32_t xfer = 0;

  xfer += oprot->writeStructBegin("BackendMiddleware_getItemsPageKeyword_result");
...
uint32_t BackendMiddleware_getItemsPageKeyword_presult::read(::apache::thrift::protocol::TProtocol* iprot) {
...
uint32_t BackendMiddleware_getUser_args::read(::apache::thrift::protocol::TProtocol* iprot) {
...
uint32_t BackendMiddleware_getUser_args::write(::apache::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  xfer += oprot->writeStructBegin("BackendMiddleware_getUser_args");
...
uint32_t BackendMiddleware_getUser_pargs::write(::apache::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  xfer += oprot->writeStructBegin("BackendMiddleware_getUser_pargs");
...
uint32_t BackendMiddleware_getUser_result::read(::apache::thrift::protocol::TProtocol* iprot) {
...
uint32_t BackendMiddleware_getUser_result::write(::apache::thrift::protocol::TProtocol* oprot) const {

  uint32_t xfer = 0;

  xfer += oprot->writeStructBegin("BackendMiddleware_getUser_result");
...
uint32_t BackendMiddleware_getUser_presult::read(::apache::thrift::protocol::TProtocol* iprot) {
...
uint32_t BackendMiddleware_getAllUser_args::read(::apache::thrift::protocol::TProtocol* iprot) {
...
uint32_t BackendMiddleware_getAllUser_args::write(::apache::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  xfer += oprot->writeStructBegin("BackendMiddleware_getAllUser_args");
...
uint32_t BackendMiddleware_getAllUser_pargs::write(::apache::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  xfer += oprot->writeStructBegin("BackendMiddleware_getAllUser_pargs");
...
uint32_t BackendMiddleware_getAllUser_result::read(::apache::thrift::protocol::TProtocol* iprot) {
...
uint32_t BackendMiddleware_getAllUser_result::write(::apache::thrift::protocol::TProtocol* oprot) const {

  uint32_t xfer = 0;

  xfer += oprot->writeStructBegin("BackendMiddleware_getAllUser_result");
...
uint32_t BackendMiddleware_getAllUser_presult::read(::apache::thrift::protocol::TProtocol* iprot) {
...
void BackendMiddlewareClient::getItemsPageKeyword(std::vector<Item> & _return, const std::string& keyWord, const int64_t pageNumber, const int64_t itemNumber)
{
  send_getItemsPageKeyword(keyWord, pageNumber, itemNumber);
  recv_getItemsPageKeyword(_return);
}

void BackendMiddlewareClient::send_getItemsPageKeyword(const std::string& keyWord, const int64_t pageNumber, const int64_t itemNumber)
{
  int32_t cseqid = 0;
  oprot_->writeMessageBegin("getItemsPageKeyword", ::apache::thrift::protocol::T_CALL, cseqid);

  BackendMiddleware_getItemsPageKeyword_pargs args;
  args.keyWord = &keyWord;
  args.pageNumber = &pageNumber;
  args.itemNumber = &itemNumber;
  args.write(oprot_);
...
void BackendMiddlewareClient::recv_getItemsPageKeyword(std::vector<Item> & _return)
{
  ...
  if (fname.compare("getItemsPageKeyword") != 0) {
    iprot_->skip(::apache::thrift::protocol::T_STRUCT);
    iprot_->readMessageEnd();
    iprot_->getTransport()->readEnd();
  }
  BackendMiddleware_getItemsPageKeyword_presult result;
  result.success = &_return;
  result.read(iprot_);
  iprot_->readMessageEnd();
  iprot_->getTransport()->readEnd();
...
void BackendMiddlewareClient::getUser(User& _return, const std::string& userID)
{
  send_getUser(userID);
  recv_getUser(_return);
}

void BackendMiddlewareClient::send_getUser(const std::string& userID)
{
  int32_t cseqid = 0;
  oprot_->writeMessageBegin("getUser", ::apache::thrift::protocol::T_CALL, cseqid);

  BackendMiddleware_getUser_pargs args;
  args.userID = &userID;
  args.write(oprot_);
...
void BackendMiddlewareClient::recv_getUser(User& _return)
{
  ...
  BackendMiddleware_getUser_presult result;
  result.success = &_return;
  result.read(iprot_);
  iprot_->readMessageEnd();
  iprot_->getTransport()->readEnd();
...
void BackendMiddlewareClient::getAllUser(std::vector<std::string> & _return)
{
  send_getAllUser();
  recv_getAllUser(_return);
}

void BackendMiddlewareClient::send_getAllUser()
{
  int32_t cseqid = 0;
  oprot_->writeMessageBegin("getAllUser", ::apache::thrift::protocol::T_CALL, cseqid);

  BackendMiddleware_getAllUser_pargs args;
  args.write(oprot_);
...
void BackendMiddlewareClient::recv_getAllUser(std::vector<std::string> & _return)
{
  ...
  BackendMiddleware_getAllUser_presult result;
  result.success = &_return;
  result.read(iprot_);
  iprot_->readMessageEnd();
  iprot_->getTransport()->readEnd();
...
void BackendMiddlewareProcessor::process_getItemsPageKeyword(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext)
{
  void* ctx = NULL;
  if (this->eventHandler_.get() != NULL) {
    ctx = this->eventHandler_->getContext("BackendMiddleware.getItemsPageKeyword", callContext);
  }
  ::apache::thrift::TProcessorContextFreer freer(this->eventHandler_.get(), ctx, "BackendMiddleware.getItemsPageKeyword");

  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->preRead(ctx, "BackendMiddleware.getItemsPageKeyword");
  }

  BackendMiddleware_getItemsPageKeyword_args args;
  args.read(iprot);
  iprot->readMessageEnd();
  uint32_t bytes = iprot->getTransport()->readEnd();

  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->postRead(ctx, "BackendMiddleware.getItemsPageKeyword", bytes);
  }

  BackendMiddleware_getItemsPageKeyword_result result;
  try {
    iface_->getItemsPageKeyword(result.success, args.keyWord, args.pageNumber, args.itemNumber);
    result.__isset.success = true;
  } catch (const std::exception& e) {
    if (this->eventHandler_.get() != NULL) {
      this->eventHandler_->handlerError(ctx, "BackendMiddleware.getItemsPageKeyword");
    }

    ::apache::thrift::TApplicationException x(e.what());
    oprot->writeMessageBegin("getItemsPageKeyword", ::apache::thrift::protocol::T_EXCEPTION, seqid);
    x.write(oprot);
    oprot->writeMessageEnd();
    oprot->getTransport()->writeEnd();
    oprot->getTransport()->flush();
  ...
  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->preWrite(ctx, "BackendMiddleware.getItemsPageKeyword");
  }

  oprot->writeMessageBegin("getItemsPageKeyword", ::apache::thrift::protocol::T_REPLY, seqid);
  result.write(oprot);
  oprot->writeMessageEnd();
  bytes = oprot->getTransport()->writeEnd();
  oprot->getTransport()->flush();
  ...
  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->postWrite(ctx, "BackendMiddleware.getItemsPageKeyword", bytes);
  }
}
...
void BackendMiddlewareProcessor::process_getUser(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext)
{
  void* ctx = NULL;
  if (this->eventHandler_.get() != NULL) {
    ctx = this->eventHandler_->getContext("BackendMiddleware.getUser", callContext);
  }
  ::apache::thrift::TProcessorContextFreer freer(this->eventHandler_.get(), ctx, "BackendMiddleware.getUser");

  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->preRead(ctx, "BackendMiddleware.getUser");
  }

  BackendMiddleware_getUser_args args;
  args.read(iprot);
  iprot->readMessageEnd();
  uint32_t bytes = iprot->getTransport()->readEnd();

  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->postRead(ctx, "BackendMiddleware.getUser", bytes);
  }

  BackendMiddleware_getUser_result result;
  try {
    iface_->getUser(result.success, args.userID);
    result.__isset.success = true;
  } catch (const std::exception& e) {
    if (this->eventHandler_.get() != NULL) {
      this->eventHandler_->handlerError(ctx, "BackendMiddleware.getUser");
    }
  ...
  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->preWrite(ctx, "BackendMiddleware.getUser");
  }
  ...
  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->postWrite(ctx, "BackendMiddleware.getUser", bytes);
  }
}

void BackendMiddlewareProcessor::process_getAllUser(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext)
{
  void* ctx = NULL;
  if (this->eventHandler_.get() != NULL) {
    ctx = this->eventHandler_->getContext("BackendMiddleware.getAllUser", callContext);
  }
  ::apache::thrift::TProcessorContextFreer freer(this->eventHandler_.get(), ctx, "BackendMiddleware.getAllUser");

  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->preRead(ctx, "BackendMiddleware.getAllUser");
  }

  BackendMiddleware_getAllUser_args args;
  args.read(iprot);
  iprot->readMessageEnd();
  uint32_t bytes = iprot->getTransport()->readEnd();

  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->postRead(ctx, "BackendMiddleware.getAllUser", bytes);
  }

  BackendMiddleware_getAllUser_result result;
  try {
    iface_->getAllUser(result.success);
    result.__isset.success = true;
  } catch (const std::exception& e) {
    if (this->eventHandler_.get() != NULL) {
      this->eventHandler_->handlerError(ctx, "BackendMiddleware.getAllUser");
    }
  ...
  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->preWrite(ctx, "BackendMiddleware.getAllUser");
  }
  ...
  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->postWrite(ctx, "BackendMiddleware.getAllUser", bytes);
  }
}
