...
class BackendMiddlewareProcessor : public ::apache::thrift::TProcessor {
 protected:
  boost::shared_ptr<BackendMiddlewareIf> iface_;
  virtual bool process_fn(apache::thrift::protocol::TProtocol* iprot, apache::thrift::protocol::TProtocol* oprot, std::string& fname, int32_t seqid, void* callContext);
 private:
  std::map<std::string, void (BackendMiddlewareProcessor::*)(int32_t, apache::thrift::protocol::TProtocol*, apache::thrift::protocol::TProtocol*, void*)> processMap_;
