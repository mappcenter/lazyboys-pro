...
public class getConfig {
    ...
    private static int numberItemIDfoTag;
    private static int numberItemCache;
    ...
    public getConfig() throws FileNotFoundException, IOException {
        ...
        numberItemIDfoTag=Integer.parseInt(pro.getProperty("numberItemIDfoTag"));
        numberItemCache=Integer.parseInt(pro.getProperty("numberItemCache"));
    ...
    public int numberItemofTag(){
        return numberItemIDfoTag;
    }
    public int numberItemCache(){
        return numberItemCache;
    }
}
